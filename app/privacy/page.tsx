  ...
  return (
    <main className="min-h-screen bg-[#f7f8fa] px-6 py-12 text-slate-950">
      <article className="mx-auto max-w-4xl rounded-3xl border bg-white p-8 shadow-sm md:p-12">
        ...
        <p className="mt-2 text-sm text-slate-500">Last updated August 29, 2026</p>
        <div className="mt-8 space-y-7 leading-7 text-slate-700">
          ...
          <section><h2 className="text-xl font-bold text-slate-950">Email communications</h2><p className="mt-2">Marketing emails are optional and are sent only when you choose to subscribe. You may unsubscribe at any time using the link included in each marketing email. Unsubscribing from marketing does not affect your NorthStock account or essential service communications. Saved-search alerts are managed separately through your saved-search settings.</p></section>
          <section><h2 className="text-xl font-bold text-slate-950">Retention and choices</h2><p className="mt-2">We retain information while your account is active and as reasonably needed for security, operations, dispute resolution, and legal requirements. You may manage saved-search alerts in your account and request access, correction, or deletion by contacting us.</p></section>
